...
const QUICK_REPLIES = [
  {
    question: "👋 ترحيب",
    localAnswer:
      "أهلًا وسهلًا 👋 نورتوا بيكابو! نقدر نساعدكم فورًا في الأسعار، الباقات، الموقع، أوقات الدوام، الحجز، وسياسة الاسترجاع."
  },
  {
    question: "الأسعار",
    localAnswer:
      "الأسعار الحالية: ساعة واحدة متوفرة، وساعتين بـ 10 دينار. باقات أعياد الميلاد تبدأ من 90 دينار وتصل إلى 250 دينار. باقات الاشتراك: 250، 200، 150، 99، 79 دينار."
  },
  {
    question: "الموقع",
    localAnswer: "نخدمكم في الأردن - الزرقاء الجديدة. أرسلوا لنا على الرقم 0777775652 ونشارككم اللوكيشن مباشرة."
  },
  {
    question: "ساعات الدوام",
    localAnswer: "متوفرين يوميًا ما عدا الجمعة والسبت. للاستفسار والتسجيل: 0777775652."
  },
  {
    question: "الحجز",
    localAnswer: "للحجز السريع تواصلوا معنا على 0777775652، أو احجزوا من الموقع مباشرة وسيتواصل معكم الفريق للتأكيد."
  },
  {
    question: "سياسة الاسترجاع",
    localAnswer: "سياسة الاسترجاع تعتمد على وقت الإلغاء ونوع الحجز. تواصلوا معنا على 0777775652 حتى نخدمكم حسب حالة الحجز."
  }
];

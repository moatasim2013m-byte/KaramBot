...
**Base URL:**
```
https://staff-messages.preview.emergentagent.com
```

**Login Page:**
```
https://staff-messages.preview.emergentagent.com/login
```

**Admin Panel:**
```
https://staff-messages.preview.emergentagent.com/admin
```

**Backend API:**
```
https://staff-messages.preview.emergentagent.com/api
```
...
**Test performed on:** `https://staff-messages.preview.emergentagent.com`
...
**URL after login:** `https://staff-messages.preview.emergentagent.com/admin`
...
### Login:
```bash
curl -X POST "https://staff-messages.preview.emergentagent.com/api/auth/login" \
...
```bash
curl -X GET "https://staff-messages.preview.emergentagent.com/api/auth/me" \
...
fetch('https://staff-messages.preview.emergentagent.com/api/auth/me', {
  headers: {
...
2. Go to: `https://staff-messages.preview.emergentagent.com/login`
...
**Tested URL:** `https://staff-messages.preview.emergentagent.com`

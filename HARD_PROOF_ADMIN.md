...
**Base URL:**
```
https://whatsapp-audit-2.preview.emergentagent.com
```

**Login Page:**
```
https://whatsapp-audit-2.preview.emergentagent.com/login
```

**Admin Panel:**
```
https://whatsapp-audit-2.preview.emergentagent.com/admin
```

**Backend API:**
```
https://whatsapp-audit-2.preview.emergentagent.com/api
```
...
**Test performed on:** `https://whatsapp-audit-2.preview.emergentagent.com`
...
**URL after login:** `https://whatsapp-audit-2.preview.emergentagent.com/admin`
...
### Login:
```bash
curl -X POST "https://whatsapp-audit-2.preview.emergentagent.com/api/auth/login" \
...
```bash
curl -X GET "https://whatsapp-audit-2.preview.emergentagent.com/api/auth/me" \
...
fetch('https://whatsapp-audit-2.preview.emergentagent.com/api/auth/me', {
  headers: {
...
2. Go to: `https://whatsapp-audit-2.preview.emergentagent.com/login`
...
**Tested URL:** `https://whatsapp-audit-2.preview.emergentagent.com`

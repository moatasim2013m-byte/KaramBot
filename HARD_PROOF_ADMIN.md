...
**Base URL:**
```
https://control-mode-2.preview.emergentagent.com
```

**Login Page:**
```
https://control-mode-2.preview.emergentagent.com/login
```

**Admin Panel:**
```
https://control-mode-2.preview.emergentagent.com/admin
```

**Backend API:**
```
https://control-mode-2.preview.emergentagent.com/api
```
...
**Test performed on:** `https://control-mode-2.preview.emergentagent.com`
...
**URL after login:** `https://control-mode-2.preview.emergentagent.com/admin`
...
### Login:
```bash
curl -X POST "https://control-mode-2.preview.emergentagent.com/api/auth/login" \
...
```bash
curl -X GET "https://control-mode-2.preview.emergentagent.com/api/auth/me" \
...
fetch('https://control-mode-2.preview.emergentagent.com/api/auth/me', {
  headers: {
...
2. Go to: `https://control-mode-2.preview.emergentagent.com/login`
...
**Tested URL:** `https://control-mode-2.preview.emergentagent.com`

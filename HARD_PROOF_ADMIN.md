...
**Base URL:**
```
https://marketing-verify.preview.emergentagent.com
```

**Login Page:**
```
https://marketing-verify.preview.emergentagent.com/login
```

**Admin Panel:**
```
https://marketing-verify.preview.emergentagent.com/admin
```

**Backend API:**
```
https://marketing-verify.preview.emergentagent.com/api
```
...
**Test performed on:** `https://marketing-verify.preview.emergentagent.com`
...
**URL after login:** `https://marketing-verify.preview.emergentagent.com/admin`
...
### Login:
```bash
curl -X POST "https://marketing-verify.preview.emergentagent.com/api/auth/login" \
...
```bash
curl -X GET "https://marketing-verify.preview.emergentagent.com/api/auth/me" \
...
fetch('https://marketing-verify.preview.emergentagent.com/api/auth/me', {
  headers: {
...
2. Go to: `https://marketing-verify.preview.emergentagent.com/login`
...
**Tested URL:** `https://marketing-verify.preview.emergentagent.com`

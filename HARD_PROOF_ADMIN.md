...
**Base URL:**
```
https://iphone-scanner-test.preview.emergentagent.com
```

**Login Page:**
```
https://iphone-scanner-test.preview.emergentagent.com/login
```

**Admin Panel:**
```
https://iphone-scanner-test.preview.emergentagent.com/admin
```

**Backend API:**
```
https://iphone-scanner-test.preview.emergentagent.com/api
```
...
**Test performed on:** `https://iphone-scanner-test.preview.emergentagent.com`
...
**URL after login:** `https://iphone-scanner-test.preview.emergentagent.com/admin`
...
### Login:
```bash
curl -X POST "https://iphone-scanner-test.preview.emergentagent.com/api/auth/login" \
...
```bash
curl -X GET "https://iphone-scanner-test.preview.emergentagent.com/api/auth/me" \
...
fetch('https://iphone-scanner-test.preview.emergentagent.com/api/auth/me', {
  headers: {
...
2. Go to: `https://iphone-scanner-test.preview.emergentagent.com/login`
...
**Tested URL:** `https://iphone-scanner-test.preview.emergentagent.com`

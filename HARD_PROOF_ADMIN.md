...
**Base URL:**
```
https://whatsapp-backend-ops.preview.emergentagent.com
```

**Login Page:**
```
https://whatsapp-backend-ops.preview.emergentagent.com/login
```

**Admin Panel:**
```
https://whatsapp-backend-ops.preview.emergentagent.com/admin
```

**Backend API:**
```
https://whatsapp-backend-ops.preview.emergentagent.com/api
```
...
**Test performed on:** `https://whatsapp-backend-ops.preview.emergentagent.com`
...
**URL after login:** `https://whatsapp-backend-ops.preview.emergentagent.com/admin`
...
### Login:
```bash
curl -X POST "https://whatsapp-backend-ops.preview.emergentagent.com/api/auth/login" \
...
```bash
curl -X GET "https://whatsapp-backend-ops.preview.emergentagent.com/api/auth/me" \
...
fetch('https://whatsapp-backend-ops.preview.emergentagent.com/api/auth/me', {
  headers: {
...
2. Go to: `https://whatsapp-backend-ops.preview.emergentagent.com/login`
...
**Tested URL:** `https://whatsapp-backend-ops.preview.emergentagent.com`

...
**Base URL:**
```
https://codebases.preview.emergentagent.com
```

**Login Page:**
```
https://codebases.preview.emergentagent.com/login
```

**Admin Panel:**
```
https://codebases.preview.emergentagent.com/admin
```

**Backend API:**
```
https://codebases.preview.emergentagent.com/api
```
...
**Test performed on:** `https://codebases.preview.emergentagent.com`
...
**URL after login:** `https://codebases.preview.emergentagent.com/admin`
...
### Login:
```bash
curl -X POST "https://codebases.preview.emergentagent.com/api/auth/login" \
...
```bash
curl -X GET "https://codebases.preview.emergentagent.com/api/auth/me" \
...
fetch('https://codebases.preview.emergentagent.com/api/auth/me', {
  headers: {
...
2. Go to: `https://codebases.preview.emergentagent.com/login`
...
**Tested URL:** `https://codebases.preview.emergentagent.com`

...
**Base URL:**
```
https://credit-control-16.preview.emergentagent.com
```

**Login Page:**
```
https://credit-control-16.preview.emergentagent.com/login
```

**Admin Panel:**
```
https://credit-control-16.preview.emergentagent.com/admin
```

**Backend API:**
```
https://credit-control-16.preview.emergentagent.com/api
```
...
**Test performed on:** `https://credit-control-16.preview.emergentagent.com`
...
**URL after login:** `https://credit-control-16.preview.emergentagent.com/admin`
...
### Login:
```bash
curl -X POST "https://credit-control-16.preview.emergentagent.com/api/auth/login" \
...
```bash
curl -X GET "https://credit-control-16.preview.emergentagent.com/api/auth/me" \
...
fetch('https://credit-control-16.preview.emergentagent.com/api/auth/me', {
  headers: {
...
2. Go to: `https://credit-control-16.preview.emergentagent.com/login`
...
**Tested URL:** `https://credit-control-16.preview.emergentagent.com`

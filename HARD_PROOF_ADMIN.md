...
**Base URL:**
```
https://peekaboo-dashboard.preview.emergentagent.com
```

**Login Page:**
```
https://peekaboo-dashboard.preview.emergentagent.com/login
```

**Admin Panel:**
```
https://peekaboo-dashboard.preview.emergentagent.com/admin
```

**Backend API:**
```
https://peekaboo-dashboard.preview.emergentagent.com/api
```
...
**Test performed on:** `https://peekaboo-dashboard.preview.emergentagent.com`
...
**URL after login:** `https://peekaboo-dashboard.preview.emergentagent.com/admin`
...
### Login:
```bash
curl -X POST "https://peekaboo-dashboard.preview.emergentagent.com/api/auth/login" \
...
```bash
curl -X GET "https://peekaboo-dashboard.preview.emergentagent.com/api/auth/me" \
...
fetch('https://peekaboo-dashboard.preview.emergentagent.com/api/auth/me', {
  headers: {
...
2. Go to: `https://peekaboo-dashboard.preview.emergentagent.com/login`
...
**Tested URL:** `https://peekaboo-dashboard.preview.emergentagent.com`

...
**Base URL:**
```
https://staff-bookings-qa.preview.emergentagent.com
```

**Login Page:**
```
https://staff-bookings-qa.preview.emergentagent.com/login
```

**Admin Panel:**
```
https://staff-bookings-qa.preview.emergentagent.com/admin
```

**Backend API:**
```
https://staff-bookings-qa.preview.emergentagent.com/api
```
...
**Test performed on:** `https://staff-bookings-qa.preview.emergentagent.com`
...
**URL after login:** `https://staff-bookings-qa.preview.emergentagent.com/admin`
...
### Login:
```bash
curl -X POST "https://staff-bookings-qa.preview.emergentagent.com/api/auth/login" \
...
```bash
curl -X GET "https://staff-bookings-qa.preview.emergentagent.com/api/auth/me" \
...
fetch('https://staff-bookings-qa.preview.emergentagent.com/api/auth/me', {
  headers: {
...
2. Go to: `https://staff-bookings-qa.preview.emergentagent.com/login`
...
**Tested URL:** `https://staff-bookings-qa.preview.emergentagent.com`

...
**Base URL:**
```
https://whatsapp-campaigns-4.preview.emergentagent.com
```

**Login Page:**
```
https://whatsapp-campaigns-4.preview.emergentagent.com/login
```

**Admin Panel:**
```
https://whatsapp-campaigns-4.preview.emergentagent.com/admin
```

**Backend API:**
```
https://whatsapp-campaigns-4.preview.emergentagent.com/api
```
...
**Test performed on:** `https://whatsapp-campaigns-4.preview.emergentagent.com`
...
**URL after login:** `https://whatsapp-campaigns-4.preview.emergentagent.com/admin`
...
### Login:
```bash
curl -X POST "https://whatsapp-campaigns-4.preview.emergentagent.com/api/auth/login" \
...
```bash
curl -X GET "https://whatsapp-campaigns-4.preview.emergentagent.com/api/auth/me" \
...
fetch('https://whatsapp-campaigns-4.preview.emergentagent.com/api/auth/me', {
  headers: {
...
2. Go to: `https://whatsapp-campaigns-4.preview.emergentagent.com/login`
...
**Tested URL:** `https://whatsapp-campaigns-4.preview.emergentagent.com`

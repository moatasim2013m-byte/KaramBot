...
**Base URL:**
```
https://transient-token-auth.preview.emergentagent.com
```

**Login Page:**
```
https://transient-token-auth.preview.emergentagent.com/login
```

**Admin Panel:**
```
https://transient-token-auth.preview.emergentagent.com/admin
```

**Backend API:**
```
https://transient-token-auth.preview.emergentagent.com/api
```
...
**Test performed on:** `https://transient-token-auth.preview.emergentagent.com`
...
**URL after login:** `https://transient-token-auth.preview.emergentagent.com/admin`
...
### Login:
```bash
curl -X POST "https://transient-token-auth.preview.emergentagent.com/api/auth/login" \
...
```bash
curl -X GET "https://transient-token-auth.preview.emergentagent.com/api/auth/me" \
...
fetch('https://transient-token-auth.preview.emergentagent.com/api/auth/me', {
  headers: {
...
2. Go to: `https://transient-token-auth.preview.emergentagent.com/login`
...
**Tested URL:** `https://transient-token-auth.preview.emergentagent.com`

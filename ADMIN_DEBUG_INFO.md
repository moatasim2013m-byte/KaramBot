...
**Base URL:** `https://codebases.preview.emergentagent.com`

**Direct Admin Panel URL:** `https://codebases.preview.emergentagent.com/admin`

**Backend API URL:** `https://codebases.preview.emergentagent.com/api`
...
1. Go to: `https://codebases.preview.emergentagent.com/login`
2. Enter:
...
3. Try to access: `https://codebases.preview.emergentagent.com/admin`

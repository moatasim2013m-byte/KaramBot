...
**Base URL:** `https://iphone-scanner-test.preview.emergentagent.com`

**Direct Admin Panel URL:** `https://iphone-scanner-test.preview.emergentagent.com/admin`

**Backend API URL:** `https://iphone-scanner-test.preview.emergentagent.com/api`
...
1. Go to: `https://iphone-scanner-test.preview.emergentagent.com/login`
2. Enter:
...
3. Try to access: `https://iphone-scanner-test.preview.emergentagent.com/admin`

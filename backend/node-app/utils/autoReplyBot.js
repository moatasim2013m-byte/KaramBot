...
const keywordMap = [
  ...
  },
  {
    ...
    reply:
      '💛 Peekaboo Main (الطابق الثاني): مناسب لعمر 1-10 سنوات.\n👶 الطفل أقل من 3 سنوات ما بنترك لحاله ولازم يكون معه ولي أمر/مرافق داخل المنطقة الرئيسية.\n👶 Daycare (الطابق الثالث): لعمر 1-4 سنوات وبإشراف مختصات تربية.\n📞 للاستفسار: 0777775652'
  },
  {
  ...
  },
  {
    ...
    reply:
      '🏢 مرافق Peekaboo:\n🎠 المنطقة الرئيسية (الطابق الثاني) لعمر 1-10 سنوات.\n👶 Daycare (الطابق الثالث) لعمر 1-4 سنوات بإشراف مختصات تربية.\n☕ للأهالي: جلسات + كافيه + متابعة عبر الشاشات.\n📞 0777775652'
  },
  {
    key: 'safety',
    keywords: [

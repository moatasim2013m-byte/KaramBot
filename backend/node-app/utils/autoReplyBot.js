...
const DETERMINISTIC_INTENT_PATTERNS = {
  play_pricing: [
    ...
    'ممكن اسعار اللعب', 'ممكن أسعار اللعب',
    'بكم الساعة', 'بكم الساعه', 'الساعة بكم', 'الساعه بكم',
    'اسعار الالعاب', 'أسعار الالعاب'
  ],
  hours: [
...
const keywordMap = [
  ...
  {
    // Specific play-area pricing — must appear BEFORE the generic `pricing` entry so
    // that phrase keywords like "اسعار اللعب" score higher and take precedence.
    key: 'play_pricing',
    keywords: [
      'اسعار اللعب', 'أسعار اللعب', 'سعر اللعب',
      'ممكن اسعار اللعب', 'ممكن أسعار اللعب',
      'اسعار الالعاب', 'أسعار الالعاب', 'أسعار الألعاب', 'اسعار الألعاب',
      'رسوم اللعب', 'سعر الدخول', 'رسوم الدخول',
      'قديش الساعه', 'قديش الساعة',
      'كم الساعه', 'كم الساعة',
      'بكم الساعه', 'بكم الساعة',
      'بكام الساعه', 'بكام الساعة',
      'سعر الساعه', 'سعر الساعة',
      'الساعة بكم', 'الساعه بكم',
      'الدخول بكم', 'بكم الدخول', 'بكم دخول',
      'تذكرة بكم', 'التذكرة بكم'
    ],
    buildReply: async ({ footer }) => {
      const pricingText = await buildPlayPricingText();
      return [pricingText, footer].filter(Boolean).join('\n');
    }
  },
  {
    key: 'pricing',

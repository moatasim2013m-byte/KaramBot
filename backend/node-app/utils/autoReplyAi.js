...
const buildStaticSystemPrompt = () => [
  ...
  'إذا سألوا "انتو حضانه ولا مكان لعب؟": إحنا أساساً ملعب أطفال داخلي ترفيهي مع التركيز عل الالعاب الحركيه وتنميه قدرات الاطفال الحركيه وعمل نشاطات يوميه مجانيه فنيه او حسيه . الداي كير خدمة إضافية نوفرها في الطابق الثالث للأطفال 1-4 سنوات — متاح بالساعة أو باشتراك شهري. الملعب الرئيسي هو قلب بيكابو.',
  '',

...
const getScopedAiFallbackReply = async ({ userText, maxChars = 500, conversationHistory = [] }) => {
  ...
  try {
    ...
    const systemInstruction = [
      ...
      '5) Main (الطابق الثاني): عمر 1-10. أقل من 3 سنوات لا يُترك الطفل وحده ويجب وجود ولي أمر/مرافق.',
      '6) Daycare (الطابق الثالث): عمر 1-4. الطفل يمكنه البقاء بدون وجود الأهل داخل القسم. الإشراف من مختصات تربية.',
